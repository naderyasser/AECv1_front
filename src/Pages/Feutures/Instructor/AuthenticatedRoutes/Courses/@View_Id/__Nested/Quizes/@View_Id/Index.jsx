...
const QuizDetailsBox = ({
  ...
  const HandleDelete = async () => {
    ...
    if (error) {
      ...
      onClose();
      // If deleted successfully, call the render function to refresh the data
      onRender();
    }
  };
        ...
        >
          ...
          {unlocks_at && (
            <Field
              ...
              value={formatRelativeTime(unlocks_at)}
            />
          )}
...
export default function Index() {
  ...
  return (
    <Flex
      ...
      p="4"
    >
      <QuizDetailsBox dataLoading={loading} onRender={HandleRender} {...data} />
      <Stack
        border="1px"
        borderColor="gray.200"
        p="3"
          ...
          !window.location.pathname.includes("/AddQuestions") && (
            ...
            >
              <Text
                ...
                textAlign="center"
              >
                Please select one of the options above to manage your quiz.
              </Text>
              <Text fontSize="sm" color="gray.500" mt={2} textAlign="center">
                Use "View Questions" to see all questions in this quiz or "Add
                Questions" to create new ones.
              </Text>
            </Flex>
          )}
